...
public class PizzaService(PizzaContext context)
{
    ...
    public void AddTopping(int PizzaId, int ToppingId)
    {
        ...
        {
            throw new InvalidOperationException("Pizza To Update or Topping doesn't exist\n");
        }
    ...
    {
        var pizzaToUpdate = _context.Pizzas.Find(PizzaId);
        var newSauce = _context.Sauces.Find(SauceId);
        if(pizzaToUpdate is null || newSauce is null)
        {
            throw new InvalidOperationException("pizza or sauce doesn't exist ");
        }

        pizzaToUpdate.Sauce = newSauce;
        _context.SaveChanges();
    }
